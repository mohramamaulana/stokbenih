<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
      ...
      <li class="menu-item">
        <a href="{{ URL::to('admin/roles')}}" class="menu-link">
      ...
      <li class="menu-item">
        <a
          href="{{ URL::to('admin/users') }}" class="menu-link">
      ...
      <li class="menu-item">
        ...
        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{ URL::to('admin/stok') }}" class="menu-link">
      ...
      <li class="menu-item">
        <a href="javascript:void(0)" class="menu-link menu-toggle">
          ...
          <div data-i18n="Extended UI">Penyaluran</div>
        </a>
        <ul class="menu-sub">
          <li class="menu-item">
